...
block VarLimPIDFreeze "P, PI, PD, and PID controller with limited output (with adjustable limits), anti-windup compensation, setpoint weighting, optional feed-forward and optional freezing of the state"
