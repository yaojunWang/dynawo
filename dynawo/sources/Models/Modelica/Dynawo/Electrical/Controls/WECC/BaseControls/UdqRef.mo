...
block UdqRef "Calculation of setpoints for ud and uq of inner voltage source with source impedance R+jX based on current setpoints id and iq at measured terminal voltage ud uq "
