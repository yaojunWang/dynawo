...
model PVCurrentSource "WECC PV Model on infinite Bus"
  ...
  Dynawo.Electrical.Photovoltaics.WECC.PVCurrentSource PV(SNom = 100, RPu = 0, XPu = 0.15, P0Pu = -0.7, Q0Pu = -0.2, U0Pu = 1.00004131, UPhase0= 0.000144688) annotation(
    Placement(visible = true, transformation(origin = {20, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 180)));
  Modelica.Blocks.Sources.Constant PRefPu(k = PV.PGen0Pu) annotation(
    Placement(visible = true, transformation(origin = {80, -32}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ...
  Modelica.Blocks.Sources.Constant OmegaRefPu(k = 1) annotation(
    Placement(visible = true, transformation(origin = {80, 34}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
equation
  ...
  connect(OmegaRefPu.y, PV.OmegaRefPu) annotation(
    Line(points = {{70, 34}, {54, 34}, {54, 12}, {42, 12}}, color = {0, 0, 127}));
  connect(QRefPu.y, PV.QRefPu) annotation(
    Line(points = {{70, 0}, {44, 0}, {44, 0}, {42, 0}}, color = {0, 0, 127}));
  connect(PRefPu.y, PV.PRefPu) annotation(
    Line(points = {{70, -32}, {54, -32}, {54, -12}, {42, -12}, {42, -12}}, color = {0, 0, 127}));
  line.switchOffSignal1.value = false;
  line.switchOffSignal2.value = false;
  annotation(preferredView = "diagram",
    experiment(StartTime = 0, StopTime = 12, Tolerance = 0.00001, Interval = 0.001),
